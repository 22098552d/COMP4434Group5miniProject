...
class Exp_Logistic_Regression(Exp_Basic):
    def __init__(self, args):
        super(Exp_Logistic_Regression, self).__init__(args)

    def _build_model(self):
        model = LogisticRegression(self.args.enc_in * self.args.seq_len).float()
    ...
    def vali(self, vali_data, vali_loader, criterion):
        ...
        with torch.no_grad():
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                batch_y = batch_y[:, 0, 0].unsqueeze(1)
    ...
    def test(self, setting, test=0):
        ...
        f = open("result_logistic_regression.txt", 'a')
        f.write(setting + "  \n")
