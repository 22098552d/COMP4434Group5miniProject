...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        if self.task_name == 'logistic_regression':
            self.logistic_regression = LogisticRegression(configs.d_model * configs.seq_len)
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        if self.task_name == 'logistic_regression':
            ...
            # MultiScale-CrissCrossAttention 作为过去的编码器
            for i in range(self.layer):
            ...
            dec_out = self.logistic_regression(output)  # (batch_size, 1)
            return dec_out
        else:
